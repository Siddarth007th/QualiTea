...
CREATE TABLE IF NOT EXISTS qa_attributes (
  ...
  CONSTRAINT fk_attr_prereq    FOREIGN KEY (prerequisite_id) REFERENCES qa_attributes(id)  ON DELETE SET NULL
);
...
CREATE TABLE IF NOT EXISTS qa_results (
  ...
  CONSTRAINT fk_result_attr    FOREIGN KEY (attribute_id) REFERENCES qa_attributes(id) ON DELETE CASCADE,
